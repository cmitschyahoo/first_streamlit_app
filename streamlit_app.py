...
streamlit.text(fruityvice_response.json()) # who likes to look at json?

fruityvice_normalized = pandas.json_normalize(fruityvice_response.json()) # How about some normalized json??
